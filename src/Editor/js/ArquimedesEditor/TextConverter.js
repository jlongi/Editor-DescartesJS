...
var descartesJS = (function(descartesJS) {
   ...
   *
   */
  descartesJS.TextConverter = function() {
  }

  /**
   *
   */
  descartesJS.TextConverter.prototype.toRTF = function(content) {
...
// console.log(output);
   ...
   *
   */
  descartesJS.TextConverter.prototype.toRTFAux = function(domNode) {
    var txt = "";
    var children_i;
    var children_i_css;
    var fontSize;
    ...
    for (var i=0, l=domNode.children.length; i<l; i++) {
      ...
      if ((children_i_class !== "NarrowSpaceNode") && (children_i.textContent !== "") && (children_i.textContent !== descartesJS.narrowSpace)) {
...
// console.log(children_i);
   ...
   *
   */
  descartesJS.TextConverter.prototype.formulaToRTF = function(domNode) {
    var txt = "";
    ...
    for (var i=0, l=domNode.children.length; i<l; i++) {
      ...
      if (children_i_class.match(/^TextNode/)) {
        if (children_i.textContent !== descartesJS.narrowSpace) {
      ...
      if (children_i_class.match(/^DynamicTextNode/)) {
        ...
        var num = descartesJS.getChildrenByType(components[0], "NumeratorNode");
        var den = descartesJS.getChildrenByType(components[1], "DenominatorNode");
        ...
        var index = descartesJS.getChildrenByType(children_i, "IndexNode");
        var radicand = descartesJS.getChildrenByType(children_i, "RadicandNode");
        ...
        var sumTo = descartesJS.getChildrenByType(sumContainer, "SumToNode");
        var sumFrom = descartesJS.getChildrenByType(sumContainer, "SumFromNode");
        var sumWhat = descartesJS.getChildrenByType(children_i, "SumWhatNode");
        ...
        var integralTo = descartesJS.getChildrenByType(integralContainer, "IntegralToNode");
        var integralFrom = descartesJS.getChildrenByType(integralContainer, "IntegralFromNode");
        var integralWhat = descartesJS.getChildrenByType(children_i, "IntegralWhatNode");
        ...
        var limitTo = descartesJS.getChildrenByType(limitContainer, "LimitToNode");
        var limitFrom = descartesJS.getChildrenByType(limitContainer, "LimitFromNode");
        var limitWhat = descartesJS.getChildrenByType(children_i, "LimitWhatNode");
        ...
        for (var mi=0; mi<rows; mi++) {
          for (var mj=0; mj<columns; mj++) {
            element = descartesJS.getChildrenByType(components[mi].children[mj], "MatrixElementNode");
        ...
        for (var di=0; di<parts; di++) {
          element = descartesJS.getChildrenByType(components[di], "CasesElementNode");
          txt += "{" + addSpaceAtEnd(this.formulaToRTF(element), "\\element") + "}";
        }
        txt += "}";
      }
...
// console.log(children_i);
   ...
   *
   */
  descartesJS.TextConverter.prototype.addToFontTable = function(style) {
    var family;
    var fontId = "";
   ...
   *
   */
  descartesJS.TextConverter.prototype.getFontTable = function() {
    var output = "{\\fonttbl";
   ...
   *
   */
  descartesJS.TextConverter.prototype.addToColorTable = function(node) {
   ...
   *
   */
  descartesJS.TextConverter.prototype.getColorTable = function() {
