...
var editor = (function(editor) {
     ...
     *
     */
    editor.SymbolTable.prototype.changeActive = function(index) {
     ...
     *
     */
    editor.SymbolTable.prototype.updateSymbols = function(scroll_pos) {
      var antIndex = null;
      var char;
      for (var i=0; i<cell_total; i++) {
     ...
     *
     */
    editor.SymbolTable.prototype.open = function(textArea, selection) {
     ...
     * 
     */
    editor.SymbolTable.prototype.close = function(symbol) {
     ...
     * 
     */
    editor.SymbolTable.prototype.translate = function() {
