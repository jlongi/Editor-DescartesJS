...
var tooltip = (function(tooltip) {
 ...
 tooltip.ing = 
 {
	...
	Definitions: {
		...
		file: 'Text file (with .txt extension recommended) in which the values of the elements of the vector appear in order, separated by a line break.\n\nThe values can be numeric or string, in which case they must appear in single quotes, for example \'value \'.',
	...
	Spaces: {
		...
		"O.x": 'Distance in pixels to the right of the center of the space, between the center of the space to the point where the origin of coordinates will be placed.\n\nTo modify it, one must refer to it as <id>.Ox where <id> is the space identifier.\n\nNote: It is important that these identifiers do not contain spaces or operator symbols.',
		"O.y": 'Distance in pixels downwards from the center of the space, between the center of the space to the point where the origin of coordinates will be placed.\n\nTo modify it, one must refer to it as <id>.Oy where <id> is the space identifier.\n\nNote: It is important that these identifiers do not contain spaces or operator symbols.',
	...
	Controls: {
		...
		image_CTRGRAPHIC: 'File name of an image that will ve used instead of the circle that Descartes uses to display this graphic control.',
		...
		keyboard: 'When activated, it shows a virtual keyboard to modify the value of the text field.\n\nThe default value is not checked.',
		kblayout: 'Layout of the keys to be used on the virtual keyboard.',
