...
var tooltip = (function(tooltip) {
 ...
 tooltip.esp = 
 {
	...
	Buttons: {
		...
		expand: 'Opciones para modificar las dimensiones de la escena.\n\n"Cubrir": cambia solo el ancho y el alto de las escenas que tengan un valor del 100%, para que tengan las dimensiones de su contenedor.\n\n"Escalar": modifica la escala de los pixeles de la escena para cubrir las dimensiones de su contenedor, dando un efecto de zoom general en toda la escena.\n\nEl valor por defecto es vacío, lo que indica no realizar cambios en las dimensiones.',
	...
	Definitions: {
		...
		evaluate: 'Opciones que permiten definir si la constante, la expresión del vector o el algoritmo deben evaluarse cada vez que el usuario modifica un control o solamente una vez al iniciarse la escena.\n\nEs importante seleccionar "una sola vez" cuando sea factible para que el funcionamiento de la escena sea más rápido.',
		...
		whileExpr: 'Expresión booleana que determina la condición para repetir las instrucciones del parámetro "hacer".',
	...
	Controls: {
		...
		keyboard: 'Al estar activado muestra un teclado virtual para modificar el valor del campo de texto.\n\nEl valor por defecto es no activado.',
		kblayout: 'Disposición de las teclas a utilizar en el teclado virtual.',
		kbexp: 'Posición de la esquina superior izquierda del teclado virtual.',
		color_CTRSCROLL: 'Color de fondo de la barra de desplazamiento.',
		colorInt_CTRSCROLL: 'Color del manipulador y flechas de la barra de desplazamiento.',
		color_CTRSLIDER: 'Color de fondo del deslizador.',
		colorInt_CTRSLIDER: 'Color del manipulador del deslizador.',
	},
	...
	Graphics: {
		...
		expression_FILL: 'Expresión del tipo (X,Y), donde X e Y son expresiones reales cualesquiera que representan las abscisa y ordenada del punto donde se iniciará el proceso de relleno o coloreo de la región cerrada que tiene al punto (X,Y) en su interior.\n\nEl valor por defecto es (0,0).',
	...
	Graphics3D: {
		...
		expression_FACE: 'Coordenadas de un polígono en el plano, es decir, una expresión de la forma:\n\n(X1,Y1)(X2,Y2)...(Xn,Yn)\n\ndonde Xi, Yi, para i=1,...,n son expresiones numéricas.',
		...
		width_SPHERE: 'Tamaño del diámetro de la esfera.\n\nEl valor por defecto es 2.',
