...
var tooltip = (function(tooltip) {
 ...
 tooltip.por = 
 {
	...
	Spaces: {
		...
		render: 'Menu desdobrável com opções \'ordem\', \'pintor\' e \'traçado de raios\' que são três diferentes métodos para desdobrar os objetos em três dimensões.\nO primeiro: \'ordem\' desenha os elementos tridimensionais de trás para frente. É o mais rápido, mas tem falhas quando os elementos dos objetos tridimensionais são grandes.\nO segundo: \'pintor\' é mais lento mas é muito mais confiável que o primeiro. Este método desenha primeiro os elementos que são encobertos por outros.\nA opção por \'traçado de raios\' enche pixel a pixel o espaço, desenhando a cor do objeto que se encontra mais perto do observador. É o método mais confiável mas é extraordinariamente lento, porque apenas se pode usar em computadores muito rápidos ou em espaços de dimensões bastante reduzidas.\n</entry>',
	...
	Controls: {
		...
		fixed: 'Determina se o número de decimais é fixo ou se, pelo contrário, se usa a notação "justa", na qual se eliminam os zeros desnecessários e o ponto decimal se também é desnecessário.\nPor exemplo: no lugar de 25.3400 se escreve 25.34 e em lugar de 13.0 se escreve 13 (sem ponto decimal).\nSe usa-se notação exponencial, sempre se escrevem os números na forma justa, quer dizer, o atributo fixo não intervém nesse caso.\nO valor padrão é desativado',
